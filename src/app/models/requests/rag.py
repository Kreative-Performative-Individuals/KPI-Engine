...
class KPIRequest(BaseModel):
    ...
    aggregation function, and time range. This request comes is generated by the RAG, handling the user prompt.
    ...
    def validate_machines(cls, value):
        """
        alidates the machines parameter to ensure it is a list.
